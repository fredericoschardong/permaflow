...
(function() {
    ...
    var ImgTouchCanvas = function(options) {
		...
		this.do_after_animate = options.do_after_animate;

        this.desktop = true;//options.desktop || false; //non touch events
    ...
    ImgTouchCanvas.prototype = {
        animate: function() {
			if(this.canvas.style.display != "none"){
				...
				if(this.do_before_animate){
					this.do_before_animate();
				}

		        requestAnimationFrame(this.animate.bind(this));

				if(this.do_after_animate){
					this.do_after_animate();
				}
			}
        },
